"""
MIMIC NN training on Madelon data (Feature selection complete)
...
import time
import sys
sys.path.append("C:/Users/jeren/OneDrive/Documents/Education/7641/CS-7641-assignment-2/ABAGAIL/ABAGAIL.jar")
...
def main():
    ...
    train(oa, classification_network, 'MIMIC', training_ints,validation_ints,testing_ints, measure)
